...
pyinstaller --clean --noconsole --onedir --icon="SilverSpoon.ico" --add-binary "7z.exe;." --add-binary "7z.dll;." --add-data "SilverSpoon.ico;." --add-data "SilverSpoon.png;." --add-data "theme_assets;theme_assets" --copy-metadata "curl_cffi" --name "SilverSpoon" pyqt_downloader.py
